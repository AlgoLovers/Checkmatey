...
object Puzzles {
    ...
    val ALL: List<Puzzle> = listOf(
        ...
        Puzzle("p14", "6rk/6pp/8/4N3/8/8/8/6K1 w - - 0 1", "질식 메이트", 1200),
        Puzzle("p15", "7k/8/5N2/8/8/8/8/K6R w - - 0 1", "아라비안 메이트", 1300),
        Puzzle("p16", "8/6k1/8/5q2/3N4/8/1B6/4K3 w - - 0 1", "디스커버드 어택", 1250),
        Puzzle("p17", "3q4/8/8/3k4/8/8/8/K6R w - - 0 1", "스큐어", 1150),
        Puzzle("p18", "4k3/8/8/3n4/8/8/8/3RK3 w - - 0 1", "기물 이득", 750),
    )
