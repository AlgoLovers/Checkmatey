...
/**
 * A small, curated set of famous historical games, bundled as PGN.
 *
 * Move scores are historical facts (not copyrightable); only third-party written annotations
 * would be. These 19th-century classics are firmly in the public domain and are the canonical
 * "study these" games for improving players.
 */
object MasterGames {
    val PGN: String = """
[Event "Paris Opera"]
